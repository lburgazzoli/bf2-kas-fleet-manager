...
/*
UpsertConnector Create a new connector
Create a new connector
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param async Perform the action in an asynchronous manner
 * @param connectorRequest Connector data
@return Connector
*/
func (a *ConnectorsApiService) UpsertConnector(ctx _context.Context, async bool, connectorRequest ConnectorRequest) (Connector, *_nethttp.Response, error) {
	var (
