...
// ConnectorNamespacesCreateApiService ConnectorNamespacesCreateApi service
type ConnectorNamespacesCreateApiService service

// CreateConnectorNamespaceOpts Optional parameters for the method 'CreateConnectorNamespace'
type CreateConnectorNamespaceOpts struct {
...
/*
CreateConnectorNamespace Returns a list of connector namespaces
Returns a list of connector namespaces
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateConnectorNamespaceOpts - Optional Parameters:
...
*/
func (a *ConnectorNamespacesCreateApiService) CreateConnectorNamespace(ctx _context.Context, localVarOptionals *CreateConnectorNamespaceOpts) (ConnectorNamespaceList, *_nethttp.Response, error) {
	var (
