...
// ConnectorNamespacesUpsertApiService ConnectorNamespacesUpsertApi service
type ConnectorNamespacesUpsertApiService service

// UpsertConnectorNamespaceOpts Optional parameters for the method 'UpsertConnectorNamespace'
type UpsertConnectorNamespaceOpts struct {
...
/*
UpsertConnectorNamespace Returns a list of connector namespaces
Returns a list of connector namespaces
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UpsertConnectorNamespaceOpts - Optional Parameters:
...
*/
func (a *ConnectorNamespacesUpsertApiService) UpsertConnectorNamespace(ctx _context.Context, localVarOptionals *UpsertConnectorNamespaceOpts) (ConnectorNamespaceList, *_nethttp.Response, error) {
	var (
